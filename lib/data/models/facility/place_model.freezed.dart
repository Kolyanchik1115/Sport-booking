...
abstract class $PlaceModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, int type, String name, LatLng latLng});
}
...
class _$PlaceModelImpl implements _PlaceModel {
  ...
  @override
  String toString() {
    return 'PlaceModel(id: $id, type: $type, name: $name, latLng: $latLng)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, type, name, latLng);
...
abstract class _PlaceModel implements PlaceModel {
  const factory _PlaceModel(
      ...
      required final LatLng latLng}) = _$PlaceModelImpl;
